...
from marketplace.views import (
    ...
    signup_view, create_store_view, add_product_view,
...
urlpatterns = [
    ...
    # این خط را به انتهای لیست urlpatterns (قبل از بسته شدن کادربندی) اضافه کن:
    ...
    # اصلاح مسیرهای بخش پرداخت و ثبت سفارش
    path('checkout/', checkout_view, name='checkout'), 
    path('payment/', payment_view, name='payment'),
    
    # مسیرهای احراز هویت و ساخت فروشگاه
